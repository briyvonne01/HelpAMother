...
class FunniesControllerTest < ActionController::TestCase
  ...
  test "should create funny" do
    assert_difference('Funny.count') do
      post :create, funny: { last_post: @funny.last_post, replies: @funny.replies, topic: @funny.topic, user_name: @funny.user_name, views: @funny.views }
    end
  ...
  test "should update funny" do
    patch :update, id: @funny, funny: { last_post: @funny.last_post, replies: @funny.replies, topic: @funny.topic, user_name: @funny.user_name, views: @funny.views }
    assert_redirected_to funny_path(assigns(:funny))
  end
