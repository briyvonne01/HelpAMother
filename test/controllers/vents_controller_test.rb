...
class VentsControllerTest < ActionController::TestCase
  ...
  test "should create vent" do
    assert_difference('Vent.count') do
      post :create, vent: { last_post: @vent.last_post, replies: @vent.replies, topic: @vent.topic, user_name: @vent.user_name, views: @vent.views }
    end
  ...
  test "should update vent" do
    patch :update, id: @vent, vent: { last_post: @vent.last_post, replies: @vent.replies, topic: @vent.topic, user_name: @vent.user_name, views: @vent.views }
    assert_redirected_to vent_path(assigns(:vent))
  end
